...
class __TwigTemplate_916fc1e189bb557003a862c7bea5df939434aac0edae928a0f5489566ceaf158 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/classy/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\la_belle\\core\\themes\\classy\\templates\\content-edit\\filter-tips.html.twig");
    }
